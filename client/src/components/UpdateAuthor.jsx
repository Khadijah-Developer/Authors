...
const UpdateAuthor = () => {
    ...
    const [isIdExists, setIsIdExists] = useState(true);
   ...
   const handleChange = (event)=> {
    ...
    const handleSubmit = (event)=> {
       ...
       return( author.name.length > 0? setAuthor({ name: "" }) : null)
    }
    return ( 
            ...
            { !isIdExists?
                <div className='m-5 p-5'>
                   ...
                   <div>
                        ...
                        {authorUpdated && <div className='alert alert-success'>User has been successfully created</div>}
